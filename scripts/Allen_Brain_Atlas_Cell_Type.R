...
### data was downloaded from Broadinstitute Sincle Cell Portal at https://portals.broadinstitute.org/single_cell
### (since cell type label was not available fomr the Allen Brain Atlas website)
### There is new data availabe now on the Allen Brain Atlas Cell Type website, which is the different version from this data set
### The new data will be updated on FUMA in near futhre
